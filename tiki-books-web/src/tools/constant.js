...
export const LIST_BOOK_TIKI_TOP_DISCOUNT_URL = `${BASE_URL}/listBookTikiTopDiscount`

export const LIST_BOOK_TIKI_AT_DATE_URL = `${BASE_URL}/booksProductAtDate`
export const LIST_BOOK_TIKI_BY_ID_AT_DATE_URL = `${BASE_URL}/booksProductByIdAtDate`
export const LIST_BOOK_TIKI_TOP_DISCOUNT_AT_DATE_URL = `${BASE_URL}/listBookTikiTopDiscountAtDate`
